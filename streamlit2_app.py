...
if file_1 and file_2:
    ...
    if page == "📊 Utilization Analytics":
        ...
        # --- กราฟที่ 1: เปรียบเทียบจำนวนวันรายวอร์ด ---
        ...
        fig_bar.update_layout(font=dict(size=18, color="#000"), plot_bgcolor='rgba(0,0,0,0)', 
                              legend=dict(orientation="h", yanchor="bottom", y=1.02, xanchor="right", x=1))
        fig_bar.update_traces(textposition='outside', textfont_size=20, textfont_weight="bold")
        st.plotly_chart(fig_bar, use_container_width=True)

        # --- กราฟที่ 2: อัตราการเติบโตรายแผนก (%) ---
        ...
        fig_growth = px.bar(df_compare, x='% Growth', y='Ward', orientation='h',
                            ...
                            text_auto='d')
        fig_growth.update_layout(font=dict(size=18, color="#000"), plot_bgcolor='rgba(0,0,0,0)', showlegend=False)
